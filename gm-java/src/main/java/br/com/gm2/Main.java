...
public class Main {
    ...
    private static boolean processFiles(AbstractStrategy strategy, String srcFile, String packedFile, boolean deleteSrcFiles) throws IOException {
        GMPack pack = new GMPack();
        pack.crumbIt(srcFile);
        GMUnpack unpack = new GMUnpack();
        File src = new File(srcFile);
        MVOperator.metrics = 0;
        ...
        System.out.println("Number of Calls: " + MVOperator.metrics);
